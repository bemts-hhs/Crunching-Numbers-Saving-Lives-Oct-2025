...
Note that 95% confidence intervals do not tell us how "confident" we are. Statistics is not about emotions!
It is all about inferring where we might expect true performance to be if we had more information.
This is a way to better understand the data given observed error.
